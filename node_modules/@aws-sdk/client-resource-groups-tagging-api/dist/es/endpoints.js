...
var AWS_TEMPLATE = "tagging.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "tagging.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "tagging.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "tagging.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "tagging.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    switch (region) {
        ...
        case "eu-south-1":
            regionInfo = {
                hostname: "tagging.eu-south-1.amazonaws.com",
                partition: "aws",
            };
            break;
        case "eu-west-1":
    ...
    return Promise.resolve(__assign({ signingService: "tagging" }, regionInfo));
};
