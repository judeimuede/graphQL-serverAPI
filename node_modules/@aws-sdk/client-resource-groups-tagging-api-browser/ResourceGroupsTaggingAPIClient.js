...
var ResourceGroupsTaggingAPIConfiguration_1 = require("./ResourceGroupsTaggingAPIConfiguration");
var ServiceMetadata_1 = require("./model/ServiceMetadata");
var ResourceGroupsTaggingAPIClient = /** @class */ (function () {
    function ResourceGroupsTaggingAPIClient(configuration) {
        this.middlewareStack = new __aws_sdk_middleware_stack.MiddlewareStack();
        this.config = __aws_sdk_config_resolver.resolveConfiguration(configuration, ResourceGroupsTaggingAPIConfiguration_1.configurationProperties, this.middlewareStack);
    ...
    ResourceGroupsTaggingAPIClient.prototype.send = function (command, cb) {
